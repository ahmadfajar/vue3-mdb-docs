...
import { textCssFromOklchColor, useMaterialColorInfo, type TColor } from './color-api.ts';
import { contextColorsLight, fullColors, mainColors, materialColors } from './color-names.ts';
...
<template>
  <div class="docs-color-table">
    <div v-if="palette === 'contextual'" class="row gy-4">
      <div v-for="(_value, key) in contextColorsLight" :key="key" class="col-6 col-md-4">
    ...
    <div v-else-if="palette === 'primary'" class="row gy-4">
      <div v-for="(value, key) in mainColors" :key="value" class="col-6 col-md-4 col-xl-3">
        <div
          :class="[
    ...
    <div v-else-if="palette === 'material'" class="row gy-4 gx-3 material-colors">
      <div v-for="(item, key) in materialColors" :key="key" class="col-sm-6 col-xl-4">
    ...
    <div v-else-if="palette === 'testColor'" class="row gy-4">
      <div v-for="name in colorNames" :key="name" class="col-6 col-md-3">
        ...
        <div class="md-shadow">
          <template v-for="(value, prop) in fullColors[name as TColor]" :key="name + prop">
