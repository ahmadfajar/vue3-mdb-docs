  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Colors', link: '/reference/colors' },
      {
        ...
        collapsed: true,
        items: [
          { text: 'Borders', link: '/reference/css-utils/borders' },
          { text: 'Display', link: '/reference/css-utils/display' },
          { text: 'Flex', link: '/reference/css-utils/flex' },
          { text: 'Grid', link: '/reference/css-utils/grid' },
          { text: 'Position', link: '/reference/css-utils/position' },
          { text: 'Shadows', link: '/reference/css-utils/shadows' },
          { text: 'Size', link: '/reference/css-utils/size' },
          { text: 'Spacing', link: '/reference/css-utils/spacing' },
          { text: 'Text', link: '/reference/css-utils/text' },
          { text: 'Others', link: '/reference/css-utils/others' },
        ],
      },
    ],
  },
